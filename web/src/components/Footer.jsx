    ...
    <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
      <div class="md:w-[316px]">
        ...
        <h1 class="text-white font-extrabold">
          <span class="text-rose-600">AH-</span>BuyBuzz
        </h1>
        </p>
        <p class="mt-[18px] text-[15px] font-normal text-white/[80%]">"At AH-BUYYBUZZ, we don’t just sell [products/services]—we deliver smiles! Dive into a world of amazing deals and find what makes you happy.".</p>
      ...
      <div class="md:w-[316px]">
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="tel:+911800123444" class="font-Inter text-[14px] font-medium text-white">+92 340668190 & +92 3217249537</a>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">azazk9388@gmail.com</a>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium text-[#fff]">DHA Phase#5 Near ISL , Lahore Pakistan</a>
      ...
      <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
        <div class="">
          ...
          <ul>
            ...
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/our-tutors">Products</a></li>
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/become-a-tutor">Services</a></li>
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/plans-and-pricing">About</a></li>
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="/terms-and-conditions">Contact</a></li>
            
          </ul>
        </div>
        <div class="mt-6 flex flex-col gap-4 sm:mt-0">
          <p class="text-deutziawhite font-inter text-[18px] font-medium">DOWNLOAD THE APP
            <li>
              Coming Soon
            </li>
          </p>
