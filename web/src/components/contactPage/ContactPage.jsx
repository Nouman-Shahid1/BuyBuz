    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400"> AH-BUYBUZZ
                </p>
            </div>
        </div>
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    ...
                    We’d love to hear from you! Whether you have a question about our products, need support, or just want to give feedback, feel free to get in touch with us
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">DHA Phase#7 Near ISL , Lahore Pakistan</p>
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +92 03406681290</p>
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +92 03217249573</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: azazk9388@gmail.com</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: hafsanawaz400@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
