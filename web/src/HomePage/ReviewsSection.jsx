...
<div class="mt-6 font-[sans-serif]">
            <div class="max-w-4xl mx-auto relative">
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-800 mt-6 leading-relaxed">"Shopping on AH-BUYBUZZ has been a game-changer for me. The user-friendly interface and quick delivery make it my favorite online store!" – </p>
                </div>
                ...
                <div class="max-w-xl mt-16 mx-auto">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm leading-relaxed">The service was amazing. The quality of the products exceeded my expectations. I’ll definitely be coming back for more!".</p>
                    </div>
